...
/**
 * Kafka consumer configuration for deserializing EventEnvelope messages.
 */
@Configuration
@EnableKafka
public class KafkaConsumerConfig {
    ...
    /**
     * Create consumer factory for EventEnvelope.
     */
    @Bean
    public ConsumerFactory<String, EventEnvelope> eventEnvelopeConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.wrapitup.*");
