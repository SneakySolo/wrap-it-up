package com.wrapitup.spotify.controller;
...
/**
 * Basic health and info endpoints for spotify-service.
 */
@RestController
...
public class HealthController {
    ...
    public ResponseEntity<InfoResponse> info() {
        return ResponseEntity.ok(InfoResponse.builder()
                ...
                .version("1.0.0")
                .description("Spotify Web API integration and data normalization")
                .build());
    }
